...
public class PaymentController {
    ...
    @Operation(summary = "Create a payment order", description = "Accepted paymentMethod values: STRIPE, RAZORPAY. Returns a payment URL to redirect the user.")
    @PostMapping ("/payment/{paymentMethod}/amount/{amount}")
    public ResponseEntity<PaymentResponse>  paymentHandler(@PathVariable String paymentMethod, @PathVariable String amount, Authentication authentication) throws Exception {
